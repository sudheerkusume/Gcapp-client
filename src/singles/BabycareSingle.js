...
// const BabycareSingle = () => {
//   const { id } = useParams();
//   const {addToCart} = useCart()
//   const [product, setProduct] = useState(null);
//   const [selectedImage, setSelectedImage] = useState(null);
//   useEffect(() => {
//     axios.get(`http://localhost:3001/babycare/${id}`)
//       .then((res) => 
// {
//           setProduct(res.data);
...
//      <p className='' style={{font:'bold'}}> Size & Type</p>
//      <p style={{color:'gray', fontWeight:'lighter', fontSize:'smaller'}}>{product.size}{product.Type}</p>
...
//      <p style={{color:'gray', fontWeight:'lighter', fontSize:'smaller'}}>{product.Size}</p>
...
//      <p style={{color:'gray', fontWeight:'lighter', fontSize:'smaller'}}>MOONSTONE VENTURES LLP</p>

//      <p className='' style={{font:'bold'}}>Seller FSSAI</p>
//      <p style={{color:'gray', fontWeight:'lighter', fontSize:'smaller'}}>13323999000008</p>


//      <p className='' style={{font:'bold'}}>Disclaimer</p>
//      <p style={{color:'gray', fontWeight:'lighter', fontSize:'smaller'}}>Every effort is made to maintain the accuracy of all information. However, actual product packaging and materials may contain more and/or different information. The color of the product displayed in the image may differ from that received in the order. It is recommended not to solely rely on the details presented.</p>
...
//        <Link to={`/babycare`} className='link-style'>  <h6 className='p-2 text-success mb-lg-5' style={{fontWeight:'smaller'}}>View all by {product.Product} <span className='itspan'>➤</span></h6></Link>
//        <div class="price-box ">
...
const BabycareSingle = () => {
  ...
  useEffect(() => {
    axios.get(`https://gcapp-server.onrender.com/${id}`)
      .then((res) => 
{
          setProduct(res.data);
      setSelectedImage(res.data.image?.[0])
